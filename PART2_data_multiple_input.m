...
base_path = 'C:\Users\User\Documents\GitHub\FRA233_Lab1_G04\PART2_studyV2\';

% The names must match your Excel file prefixes exactly
wave_names = {'Step', 'Ramp', 'Stair', 'Sine', 'Chirp'}; 

folders = {'part2_Step_1_2026-01-31_20-36', ...
           'part2_Ramp_1_2026-01-31_20-39', ...
           'part2_Stair_2_2026-02-01_22-25', ...
           'part2_Sine_1_2026-01-31_20-52', ...
           'part2_Chirp_1_2026-01-31_20-57'};

% --- FILTER TOGGLE ---
use_filter = true; % Recommended: set to true for better Parameter Estimation
fc = 50;           
